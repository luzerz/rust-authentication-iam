...
use authentication_service::infrastructure::{
    AbacPolicyRepository, InMemoryAbacPolicyRepository, InMemoryRoleRepository,
    PermissionRepository, PostgresPermissionRepository, PostgresRefreshTokenRepository,
    PostgresUserRepository, RefreshTokenRepository, RoleRepository, UserRepository,
};
...
async fn main() {
    ...
    let abac_policy_repo =
        Arc::new(InMemoryAbacPolicyRepository::new()) as Arc<dyn AbacPolicyRepository>;
